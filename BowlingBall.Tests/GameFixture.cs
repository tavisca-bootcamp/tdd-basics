...
namespace BowlingBall.Tests
{
    public class GameFixture
    {
        ...
        [Theory]
        [InlineData(187,10, 9, 1, 5, 5, 7, 2, 10, 10, 10, 9, 0, 8, 2, 9, 1, 10 )]
        [InlineData(178,10, 9, 1, 5, 5, 7, 2, 10, 10, 10, 9, 0, 8, 2, 9, 1, 1 )]
        [InlineData(180,10, 9, 1, 5, 5, 7, 2, 10, 10, 10, 9, 0, 8, 2, 9, 1, 3 )]

        public void RandomInputScoreTest(int result, params int [] rolls)
        {
            Game game = new Game();
              game.MultipleRolls(rolls);
            int score = game.GetScore();
